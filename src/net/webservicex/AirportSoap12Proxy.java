...
public class AirportSoap12Proxy{
    ...
    public class Descriptor {
        ...
        private void initCommon() {
            _proxy = _service.getAirportSoap12();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null ) {
                QName portQName = new QName("http://www.webserviceX.NET", "airportSoap12");
    ...
    public AirportSoap12Proxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    public AirportSoap12Proxy(URL wsdlLocation, QName serviceName) {
